                ...
                <Fade top>
                    <div className="navbarBrandContainer" >
                        ...
                        <div className={!isScrolled ? 'contact-info-header hide' : 'contact-info-header-inline'} id="contact-info">
                            ...
                            <p className="phoneNumber"><div className="custom-tooltip">https://www.facebook.com/baranyiepuletvill</div><a rel="noreferrer" target="_blank" href="https://www.facebook.com/baranyiepuletvill" style={{textDecoration: 'none'}}><span style={{position: 'relative', top: '-3px'}}><FaFacebook /></span></a></p>
