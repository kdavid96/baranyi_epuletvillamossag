                ...
                <Fade top>
                    <div className="navbarBrandContainer" >
                        ...
                        <div className={!isScrolled ? 'contact-info-header hide' : 'contact-info-header-inline'} id="contact-info">
                            <p className="phoneNumber"><a rel="noreferrer" target="_blank" href="tel:+36306991126"style={{textDecoration: 'none'}}><span style={{position: 'relative', top: '-3px'}}><BsFillTelephoneFill /></span></a></p>
                            <p className="phoneNumber"><a rel="noreferrer" target="_blank" href="mailto:baranyiepuletvill@gmail.com"style={{textDecoration: 'none'}}><span style={{position: 'relative', top: '-3px'}}><MdEmail /></span></a></p>
                        ...
                        <a href="#about"><div className={!isScrolled ? 'logo-a' : 'logo-a logo-hide-under-1000px logo-right logo-scroll'} id="logo" style={{ backgroundImage: "url(/images/logo_official.webp)" }}></div></a>
